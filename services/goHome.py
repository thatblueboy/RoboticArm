...
from robotic_arm_quark.msg import goHomeAction, goHomeFeedback, goHomeResult
import actionlib
import rospy
...
class Controller:
    ...
    def sendToPID(self, array):
        ...
        self.setpointPublisherMotor2.publish(self.goalArray[1])
        self.setpointPublisherMotor3.publish(self.goalArray[2])
        # self.setpointPublisherMotor4.publish(self.goalArray[0])
        # self.setpointPublisherMotor5.publish(self.goalArray[0])

    def reached(self):
        if abs(self.stateArray[1] - self.goalArray[1].data < 0.4) and abs(self.stateArray[2] - self.goalArray[2].data) < 0.4:
            return True
